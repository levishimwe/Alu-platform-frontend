const ProjectUploadModal = ({ isOpen, onClose }) => {
  ...
  const categories = ['Agriculture', 'FinTech', 'HealthTech', 'EdTech', 'CleanTech', 'Other'];
  const impactAreas = ['Environment', 'Healthcare', 'Education', 'Financial Inclusion', 'Social Impact', 'Technology'];
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Impact Area</label>
                <select
                  required
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
            ...
            <div>
              ...
              />
              <p className="text-sm text-gray-500 mt-1">Upload multiple images to showcase your project</p>
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Project Video (Optional)</label>
              <input
                type="file"
                accept="video/*"
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
            ...
            <div>
              ...
              />
              <p className="text-sm text-gray-500 mt-1">Business plans, presentations, etc.</p>
            </div>
